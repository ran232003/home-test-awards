...
export const categories = [
  { name: "Best Picture", path: "bestPic", id: "bestpicture" },
  { name: "Best Director", path: "bestDir", id: "bestdirector" },
  { name: "Best Actor", path: "bestActor", id: "best-actor" },
  { name: "Best Actress", path: "bestActress", id: "best-actress" },
  {
  ...
  { name: "Best Visual Effects", path: "bestVis", id: "best-visual-effects" },
];
