...
const votestRouter = require("./routes/vote-route");
...
mongoose.connect("mongodb://localhost:27017/awwardsApp", {
...
app.use("/api/awards/vote", votestRouter);
app.use("/api/awards/user", userRouter);
